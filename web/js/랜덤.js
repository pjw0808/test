...
for(let i= 0; i <TRAVEL_LIST.length; i++){
    ...
    `<div class="item">
    <div class="img_box">
        <img src="${TRAVEL_LIST[land[i]][Math.floor(Math.random()*country)].src}" alt="" style="width:471.28px; height:300px">
    </div>
    <div class="desc_box">
        <div class="title">${TRAVEL_LIST[land[i]][Math.floor(Math.random()*country)].title}</div>
        <div class="airplane">${TRAVEL_LIST[land[i]][Math.floor(Math.random()*country)].airplane}</div>
        <div class="where">${TRAVEL_LIST[land[i]][Math.floor(Math.random()*country)].where}</div>
        <div class="price">${TRAVEL_LIST[land[i]][Math.floor(Math.random()*country)].price}</div>
    </div>
</div>
<br>`
